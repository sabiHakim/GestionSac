...
//        processRequest(request, response);
            try{
                     ...
                     String idm  = request.getParameter("mp");
                     int idma  = Integer.parseInt(request.getParameter("mp"));
                     out.println(idma);
                     String mp =  MatierePremiere.getMatierePremiere(idma).getNom();
                     out.println(mp);

                    ArrayList<GetPoketraWithDetails> pd = GetPoketraWithDetails.Recherche(mp);
                    out.println(pd);
